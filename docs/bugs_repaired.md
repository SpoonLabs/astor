...
The bugs evaluated are included in [Defects4J dataset](https://github.com/rjust/defects4j) and come from real bugs from project Apache Commns Math, Commons Lang, jFreeChart and Joda Time.
