...
//			System.out.println(errorinfo.get(number));
		...
		if (childCompiles) {
			...
			log.debug("-The created sketch compiles: SketchType " + sketchtype + " ModificationPoint "
					+ changepoint.toString() + ", errors: " + compilation.getErrorList());
		}
	...
	public List<String> scaffoldGenerationAll() {
		...
		for (ModificationPoint modificationPoint : modificationPointsToProcess) {
			...
			transformer.add(new OverloadMethodTransform(modificationPoint, modificationPointIndex,
					this.mutatorSupporter, this.projectFacade, this));
			transformer.add(new ConditionRemoveTransform(modificationPoint, modificationPointIndex,
					this.mutatorSupporter, this.projectFacade, this));
			transformer.add(new ConditionMutationTransform(modificationPoint, modificationPointIndex,
					this.mutatorSupporter, this.projectFacade, this));
			transformer.add(new ConditionAddTransform(modificationPoint, modificationPointIndex, this.mutatorSupporter,
					this.projectFacade, this));
			transformer.add(new OperatorTransform(modificationPoint, modificationPointIndex, this.mutatorSupporter,
					this.projectFacade, this));
			transformer.add(new ExpressionTransform(modificationPoint, modificationPointIndex, this.mutatorSupporter,
					this.projectFacade, this));
	...
	public List<String> scaffoldGenerationSpecific(String strategyName, ModificationPoint specificModificationPoint,
			int index) {
		...
		if (strategyName.equals("OverloadMethodTransform"))
			transformer = new OverloadMethodTransform(specificModificationPoint, index, this.mutatorSupporter,
					this.projectFacade, this);
		else if (strategyName.equals("ConditionRemoveTransform"))
			transformer = new ConditionRemoveTransform(specificModificationPoint, index, this.mutatorSupporter,
					this.projectFacade, this);
		else if (strategyName.equals("ConditionMutationTransform"))
			transformer = new ConditionMutationTransform(specificModificationPoint, index, this.mutatorSupporter,
					this.projectFacade, this);
		else if (strategyName.equals("ConditionAddTransform"))
			transformer = new ConditionAddTransform(specificModificationPoint, index, this.mutatorSupporter,
					this.projectFacade, this);
		else if (strategyName.equals("OperatorTransform"))
			transformer = new OperatorTransform(specificModificationPoint, index, this.mutatorSupporter,
					this.projectFacade, this);
		else if (strategyName.equals("ExpressionTransform"))
			transformer = new ExpressionTransform(specificModificationPoint, index, this.mutatorSupporter,
					this.projectFacade, this);
