...
public class StatSpaceSize {
	...
	public StatSpaceSize(
			int id,String type, int ingredients, String ingType,INGREDIENT_STATUS states, IngredientSpaceStrategy ingredientSpaceStrategy, AstorOperator operationType) {
		super();
		this.id = id;
		this.genType = type;
