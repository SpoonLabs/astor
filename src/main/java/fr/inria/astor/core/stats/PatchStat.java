...
public class PatchStat {
	...
	public enum HunkStatEnum {
		OPERATOR, LOCATION, LINE, SUSPICIOUNESS, MP_RANKING, ORIGINAL_CODE, BUGGY_CODE_TYPE, PATCH_HUNK_CODE, PATCH_HUNK_TYPE, INGREDIENT, INGREDIENT_SCOPE, INGREDIENT_PARENT,
	};

	public enum PatchStatEnum {
		VARIANT_ID, TIME, VALIDATION, GENERATION, HUNKS, PATCH_DIFF_ORIG, PATCH_DIFF_FORMATTED
	};
