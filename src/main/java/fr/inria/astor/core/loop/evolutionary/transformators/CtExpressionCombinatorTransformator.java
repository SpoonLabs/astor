 ...
 *
 */
public class CtExpressionCombinatorTransformator implements ModelTransformator{

	private Logger log = Logger.getLogger(CtExpressionCombinatorTransformator.class.getName());
