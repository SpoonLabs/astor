...
public abstract class AstorCoreEngine implements AstorExtensionPoint {
    ...
    public void atEnd() {
        ...
        if (!this.solutions.isEmpty()) {
            ...
            for (ReportResults out : this.getOutputResults()) {
                ...
                if (Boolean.TRUE.equals(ConfigurationProperties.getPropertyBool("removeworkingfolder"))) {
    ...
    private String determineSourceFolderInWorkspace(ProgramVariant programVariant, boolean format) {
        ...
        return projectFacade.getInDirWithPrefix(programVariant.currentMutatorIdentifier()) + suffix;
    }
    ...
    public boolean processCreatedVariant(ProgramVariant programVariant, int generation) throws Exception {
        ...
        if (Boolean.TRUE.equals(ConfigurationProperties.getPropertyBool("saveall"))) {
    ...
    public String getSolutionData(List<ProgramVariant> variants, int generation) {
        ...
        line.append(System.lineSeparator()).append(" --SOLUTIONS DESCRIPTION--").append(System.lineSeparator());
        for (ProgramVariant solutionVariant : variants) {
            line.append(getSolutionString(generation, solutionVariant));
        }
    ...
    public void initPopulation(List<SuspiciousCode> suspicious) throws Exception {
        ...
        if (Boolean.FALSE.equals(ConfigurationProperties.getPropertyBool("skipfitnessinitialpopulation"))) {
    ...
    protected void setFitnessOfPopulation() {
        ...
        if (validationResult == null) {
            log.error("Initial run of test suite fails");
                ...
                Boolean.FALSE.equals(ConfigurationProperties.getPropertyBool("canhavezerosusp"))) {
    ...
    public void initModel() throws Exception {
        ...
        if (!MutationSupporter.getFactory().Type().getAll().isEmpty()) {
            if (Boolean.TRUE.equals(ConfigurationProperties.getPropertyBool("resetmodel"))) {
    ...
    public List<SuspiciousCode> calculateSuspicious() throws Exception {
        ...
        if (Boolean.TRUE.equals(ConfigurationProperties.getPropertyBool("overridemaxtime"))) {
    ...
    protected void loadOutputResults() throws Exception {
        ...
        if (outputproperty != null && !outputproperty.trim().isEmpty()) {
            ...
            if (Boolean.TRUE.equals(ConfigurationProperties.getPropertyBool("outputjsonresult"))) {
