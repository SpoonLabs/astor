...
public abstract class AbstractMain {
    ...
    public boolean processArguments(String[] args) throws Exception {
        ...
        if (autoconfigure || Boolean.TRUE.equals(ConfigurationProperties.getPropertyBool("autoconfigure"))) {
    ...
    public boolean executeExample(String[] args) throws Exception {
        ...
        if (location != null) {
            ConfigurationProperties.properties.setProperty("flthreshold", Double.toString(faultLocalizationThreshold));
    ...
    protected ProjectRepairFacade getProjectConfiguration(String location, String projectIdentifier, String method,
        ...
        if (Boolean.FALSE.equals(ConfigurationProperties.getPropertyBool("autocompile"))) {
        ...
        return new ProjectRepairFacade(properties);
        ...
        for (String possibleSrc : possibleTestSrcFolders) {
            ...
            if (Files.exists(fSrc.toPath())) {
                ...
                if (Files.isDirectory(fSrcRelative.toPath()) &&
                        !pathResults.contains(fSrcRelative.getAbsolutePath())) {
