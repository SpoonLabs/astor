...
public class GenProgLoopTest extends BaseEvolutionaryTest {
	...
	/**
	 * Fixes a bug in a dummy artificial project. The source code of the dummy
	 * test project is in src/test/resources/testProject/src/main/java
	 * 
	 * The tests (incl the failing one) is in
	 * src/test/resources/testProject/src/test/java
	 * 
	 * To execute the test (and the failing one!) in order to see the bug: $ cd
	 * src/test/resources/testProject/ $ mvn test outputMutation
	 */
	@Test
	public void testGpBasic() throws Exception {
		 ...
		 * String projectName = "commons-lang3-before"; String packageToMine =
		 * "org.apache.commons.math"; String failing =
		 * "org.apache.commons.math.distribution.NormalDistributionTest"; String
		 * experimentName = "math-bug-280";
		 */
	...
	public void testExampleMath280() throws Exception {
		...
		this.generic(location, folder, regression, failing, dependenciespath,
				packageToInstrument, thfl);
	...
	@Override
	public void generic(String location, String folder, String regression,
			String failing, String dependenciespath,
