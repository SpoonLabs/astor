...
public class EulerIntegratorTest extends junit.framework.TestCase {
	...
	public void testDimensionCheck() {
		try {
			...
			new org.apache.commons.math.ode.nonstiff.EulerIntegrator(0.01).integrate(pb, 0.0, new double[(pb.getDimension()) + 10], 1.0, new double[(pb.getDimension()) + 10]);
