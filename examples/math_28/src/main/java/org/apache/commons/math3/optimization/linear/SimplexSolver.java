...
public class SimplexSolver extends AbstractLinearOptimizer {
	 ...
	 *                {@link #getPivotColumn(SimplexTableau)}
	 * @return row with the minimum ratio
	 */
	private Integer getPivotRow(SimplexTableau tableau, final int col) {
		// create a list of all the rows that tie for the lowest score in the minimum
		// ratio test
		...
		if (minRatioPositions.size() == 0) {
			...
			// take the row for which the corresponding basic variable has the smallest
			// index
			//
			...
			// paper)
			//
			// Additional heuristic: if we did not get a solution after half of
			// maxIterations
			// revert to the simple case of just returning the top-most row
			// This heuristic is based on empirical data gathered while investigating
			// MATH-828.
	...
	public PointValuePair doOptimize()
		...
		final SimplexTableau tableau = new SimplexTableau(getFunction(), getConstraints(), getGoalType(),
				restrictToNonNegative(), epsilon, maxUlps);
