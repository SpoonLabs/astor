...
public class MyBuggyTest {
	...
	@Test
	public void testOperation3d() {

		MyBuggy b = new MyBuggy();

		assertEquals((Integer) 120, (Integer) b.operation(120, 100, "gr"));
	}
